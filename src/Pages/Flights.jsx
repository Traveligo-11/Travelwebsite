...
const Dubai = "https://www.dubainews.app/wp-content/uploads/2024/05/dubai-to-hyderabad-flight.jpg";
const Paris = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNGDubzJ3_S43VJj3wtWosg7a8twOKnnvLSg&s";
const Economy = "https://img.etimg.com/thumb/width-1200,height-900,imgsize-352170,resizemode-75,msid-106725509/industry/transportation/airlines-/-aviation/premium-economy-class-is-here-to-stay-more-passengers-are-choosing-it-vistara.jpg";
const Business = "https://media.cntraveler.com/photos/661d5d461583bcd2283398ac/master/w_1600%2Cc_limit/Emirates_dsc-6538-363198.jpg";
const FirstClass = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5vlAqTYY1Ybe7M-Pk8HU7_8KCXwO3c-fxaA&s";
...
const Flights = () => {
  ...
  const [multiCityTrips, setMultiCityTrips] = useState([
    ...
    { from: 'Mumbai', to: 'Bangalore', date: new Date(new Date().setDate(new Date().getDate() + 3)) }
  ]);
  ...
  const features = [
    {
      icon: <FaPlane className="text-blue-500 text-2xl sm:text-3xl" />,
      title: "500+ Airlines",
  ...
  const cities = [
    ...
    'Kolkata', 'Goa', 'Kochi', 'Ahmedabad', 'Pune',
    'Jaipur', 'Lucknow', 'Chandigarh', 'Amritsar', 'Guwahati',
    'Dubai', 'London', 'New York', 'Singapore', 'Bangkok',
    'Paris', 'Sydney', 'Tokyo', 'Hong Kong'
  ];
  ...
  const popularDestinations = [
    { 
      name: 'Dubai', 
      icon: <FaCity className="text-amber-400" />,
      image: Dubai,
      price: '₹25,999',
      distance: '3h 30m',
  ...
  const flightAmenities = [
    { icon: <FaWifi className="text-blue-500" />, name: "In-flight WiFi" },
    { icon: <FaUtensils className="text-amber-500" />, name: "Meals Included" },
    { icon: <FaSuitcase className="text-purple-500" />, name: "Extra Baggage" },
    { icon: <FaHotel className="text-green-500" />, name: "Hotel Packages" }
  ];
  ...
  const cabinDetails = [
    {
      type: 'Economy',
      image: Economy,
      features: ['Standard legroom', 'Complimentary meals', 'Entertainment system', 'Checked baggage'],
    ...
    },
    {
      ...
      image: Economy,
      features: ['Extra legroom', 'Priority boarding', 'Enhanced meals', 'Extra baggage allowance'],
    ...
    },
    {
      type: 'Business',
      image: Business,
      features: ['Lie-flat seats', 'Premium dining', 'Airport lounge access', 'Priority check-in'],
      priceRange: '₹50,000 - ₹2,00,000',
      airlines: 'All full-service airlines'
    },
    {
      type: 'First Class',
      image: FirstClass,
      features: ['Private suites', 'Gourmet dining', 'Chauffeur service', 'Exclusive lounges'],
      priceRange: '₹1,00,000 - ₹5,00,000',
      airlines: 'Emirates, Etihad, Lufthansa'
    }
  ];
  ...
  const handlePassengerCountChange = (count) => {
    setPassengerCount(Math.max(1, Math.min(10, count)));
  };
    ...
    <div className="max-w-8xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center">
          <div className="flex items-center">
            <FaPlane className="text-blue-500 text-2xl sm:text-3xl mr-2" />
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            <a href="#" className="text-gray-700 hover:text-blue-600 font-medium transition-colors">Flights</a>
      ...
      >
        <div className="flex justify-between items-center mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-800 flex items-center">
            <FaPlane className="text-blue-500 mr-2 sm:mr-3 text-lg sm:text-xl" />
        ...
        >
          ...
          >
            ...
            <label className="block text-xs sm:text-sm font-bold text-blue-600 mb-1 sm:mb-2">TRAVELERS & CLASS</label>
                ...
                >
                  <div className="space-y-2 max-h-60 overflow-y-auto">
                    {cabinClasses.map((type) => (
                      <div 
                        key={type}
                        className={`p-2 rounded-lg cursor-pointer ${cabinClass === type ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-50'}`}
                        onClick={(e) => {
                          e.stopPropagation();
                          handleClassChange(type);
                        }}
                      >
                        {type}
                      </div>
            ...
            >
              ...
              <div className="p-4 sm:p-6">
                <div className="flex justify-between items-start mb-3">
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-800">{cabin.type}</h3>
                ...
                <motion.button
                  ...
                  onClick={() => {
                    ...
                    setRequestData(prev => ({
                      ...prev,
                      cabinClass: cabin.type,
                      specialRequests: `Interested in ${cabin.type} class`
                    }));
                  }}
                >
                  Book {cabin.type} Class
                </motion.button>
              </div>
            </motion.div>
          ))}
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 mb-8 sm:mb-10 lg:mb-0">
              ...
              >
                Experience <span className="font-bold text-white">comfortable flights</span> with our exclusive deals and personalized service
              </motion.p>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {[
            {
              icon: <FaPlane className="text-3xl sm:text-4xl text-blue-500" />,
            ...
            >
              <div className="absolute -right-8 -top-8 opacity-10 group-hover:opacity-20 transition-opacity">
                <FaPlane className="text-gray-800 text-5xl sm:text-6xl" />
              </div>
              ...
              <div className="p-6 sm:p-8">
                <div className="flex justify-between items-center mb-6">
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-800">
                    {submitSuccess ? 'Request Sent!' : 'Request Flight Details'}
                  </h3>
                  <button 
                ...
                {submitSuccess ? (
                  ...
                  >
                    ...
                    <p className="text-gray-600 mb-6">Your flight request has been received. Our travel expert will contact you shortly.</p>
                    <button
                      onClick={() => setShowRequestForm(false)}
