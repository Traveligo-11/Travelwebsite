...
import { 
  FaStar, FaCalendarAlt, FaHome, FaUmbrella, FaMotorcycle, 
  FaChevronDown, FaTimes, FaPhone, FaEnvelope, FaMapMarkerAlt, 
  FaPlus, FaMinus, FaMountain, FaWater, FaTree, FaUtensils
} from 'react-icons/fa';
import { GiRiceCooker, GiPagoda, GiIsland } from 'react-icons/gi';
import { MdOutlineHiking, MdLandscape, MdFamilyRestroom, MdTempleBuddhist } from 'react-icons/md';
...
const Vietnam = () => {
  ...
  const packages = [
    {
      ...
      highlights: [
        ...
        "Cruise through Halong Bay's limestone karsts",
        "Discover Hoi An's ancient town and lantern streets",
        "Experience Ho Chi Minh City's vibrant energy",
        "Mekong Delta river cruise and floating markets"
      ],
    ...
    },
    {
      ...
      highlights: [
        ...
        "Explore My Son Sanctuary (UNESCO site)",
        "Hanoi's Temple of Literature and One Pillar Pagoda",
        "Traditional water puppet show experience",
        "Hoi An's Japanese Covered Bridge and assembly halls"
      ],
      icon: <GiPagoda className="text-2xl text-amber-700" />
    },
    {
      id: 3,
      ...
      highlights: [
        ...
        "Homestay experience with ethnic minorities",
        "Motorbike tour of Ha Giang loop",
        "Kayaking in Halong Bay",
        "Bai Tu Long Bay off-the-beaten-path cruise"
      ],
      icon: <FaMotorcycle className="text-2xl text-green-600" />
    },
    {
      id: 4,
      title: "Luxury Vietnam Experience",
      duration: "12 Days / 11 Nights",
      price: "₹1,25,999",
      rating: 4.9,
      image: "/images/Vietnam3.jpeg",
      type: "luxury",
      highlights: [
        "5-star accommodations throughout",
        "Private guided tours with experts",
        "Gourmet Vietnamese cuisine experiences",
        "Luxury overnight cruise in Halong Bay",
        "Private car transfers and VIP services"
      ],
      icon: <GiIsland className="text-2xl text-amber-600" />
    }
  ];
  ...
  const galleryImages = [
    ...
    "/images/Vietnam.webp",
     "/images/Vietnam2.jpg",
   "/images/Vietnam3.jpeg",
    "/images/Vietnam4.jpeg",
    "/images/Vietnam5.jpeg",
    "/images/Vietnam7.jpeg",
    "/images/Vietnam8.jpg",
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.foodTour) specialRequests.push("Food Tour");
    if (formData.specialRequests.shopping) specialRequests.push("Shopping");
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-orange-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              From bustling cities to serene landscapes and rich cultural heritage
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-red-600 to-yellow-600 text-white px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all hover:brightness-110"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">The Essence of Vietnam</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-yellow-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Experience the perfect blend of ancient traditions and modern energy in Vietnam. From Hanoi's colonial charm to Halong Bay's natural wonders, Hoi An's lantern-lit streets to Ho Chi Minh City's dynamic pulse, Vietnam offers unforgettable experiences at every turn.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <GiPagoda className="text-4xl text-red-600" />,
              title: "Cultural Heritage",
              desc: "Explore ancient temples, imperial cities, and UNESCO sites"
            },
            {
              icon: <FaWater className="text-4xl text-blue-500" />,
              title: "Natural Beauty",
              desc: "Cruise through Halong Bay, trek rice terraces, and relax on pristine beaches"
            },
            {
              icon: <GiRiceCooker className="text-4xl text-amber-700" />,
              title: "Culinary Delights",
              desc: "From pho and banh mi to fresh seafood and street food adventures"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      {/* Packages Section */}
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-orange-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Vietnam Tour Packages</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-yellow-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Vietnam's diverse regions.
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-red-600 to-yellow-600 text-white px-6 py-2 rounded-lg font-medium shadow-md hover:shadow-lg"
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-orange-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Vietnam Through Our Lens</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-yellow-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Witness the diverse beauty of Vietnam through these stunning visuals.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our Vietnam Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-yellow-500 mx-auto mb-6 rounded-full"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <IoMdTrain className="text-4xl text-red-600" />,
                title: "Local Experts",
                desc: "Vietnamese guides with deep cultural knowledge"
              },
              {
                icon: <SiYourtraveldottv className="text-4xl text-amber-600" />,
                title: "Authentic Experiences",
                desc: "Street food tours, homestays, and local interactions"
              },
              {
                icon: <FaMotorcycle className="text-4xl text-green-600" />,
                title: "Unique Activities",
                desc: "Cycling through villages, lantern making in Hoi An"
              },
              {
                icon: <FaHome className="text-4xl text-red-500" />,
                title: "Quality Accommodation",
                desc: "Carefully selected hotels and boutique stays"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/vietnam-booking.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  {/* Package Info Side */}
                  <div className="p-8 bg-gradient-to-b from-red-600 to-yellow-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/vietnam-booking.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      >
                        ...
                        <button
                          onClick={closeBookingModal}
                          className="bg-gradient-to-r from-red-600 to-yellow-600 text-white px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg"
                        >
                          Close
                        </button>
                      </motion.div>
                      ...
                      <>
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your Vietnam Adventure</h3>
                        <p className="text-gray-600 mb-6">Secure your Vietnam tour today</p>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-red-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="foodTour"
                                  checked={formData.specialRequests.foodTour}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-red-600"
                                />
                                <span>Food Tour</span>
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-red-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="shopping"
                                  checked={formData.specialRequests.shopping}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-red-600"
                                />
                                <span>Shopping</span>
