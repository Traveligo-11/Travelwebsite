...
import { 
  FaStar, FaCalendarAlt, FaHome, FaUmbrella, FaSwimmer, 
  FaChevronDown, FaTimes, FaPhone, FaEnvelope, FaMapMarkerAlt, 
  FaPlus, FaMinus, FaWater, FaFish, FaShip, FaSun
} from 'react-icons/fa';
import { GiIsland, GiSailboat, GiSeaTurtle } from 'react-icons/gi';
import { MdOutlineKayaking, MdBeachAccess, MdDining } from 'react-icons/md';
...
const Lakshadweep = () => {
  ...
  const packages = [
    {
      id: 1,
      title: "Lakshadweep Island Hopper",
      duration: "5 Days / 4 Nights",
      price: "₹35,999",
      rating: 4.9,
      image: "/images/Lakshadeep1.jpg",
      type: "popular",
      highlights: [
        "Explore Agatti, Bangaram and Kadmat islands",
        "Daily snorkeling sessions in coral reefs",
        "Glass bottom boat rides",
        "Sunset cruise around the islands",
        "Traditional Laccadivian seafood feast"
      ],
    ...
    },
    {
      ...
      price: "₹49,999",
      rating: 4.8,
      image: "/images/Lakshadeep2.jpg",
      type: "adventure",
      highlights: [
        "PADI certified diving instructors",
        "3 diving sessions at different sites",
        "Night diving experience",
        "Underwater photography session",
        "Visit to marine conservation center"
      ],
      icon: <FaSwimmer className="text-2xl text-blue-500" />
    },
    {
      id: 3,
      title: "Luxury Private Island Escape",
      duration: "4 Days / 3 Nights",
      price: "₹75,999",
      rating: 4.7,
      image: "/images/Lakshadeep3.jpg",
      type: "luxury",
      highlights: [
        "Private beach villa on Bangaram Island",
        "Personal butler and chef service",
        "Private yacht for island hopping",
        "Spa treatments with ocean view",
    ...
    },
    {
      ...
      price: "₹42,999",
      rating: 4.6,
      image: "/images/Lakshadeep4.jpg",
      type: "family",
      highlights: [
        "Kid-friendly beach activities",
        "Shallow water snorkeling for beginners",
        "Coral reef education program",
        "Family kayaking adventure",
        "Beach games and bonfire nights"
      ],
      icon: <MdBeachAccess className="text-2xl text-green-500" />
    }
  ];

  const galleryImages = [
    "/images/Lakshadeep1.jpg",
    "/images/Lakshadeep2.jpg",
    "/images/Lakshadeep3.jpg",
    "/images/Lakshadeep4.jpg",
    "/images/Lakshadeep5.jpeg",
    "/images/Lakshadeep6.avif",
    "/images/Lakshadeep7.jpeg",
    "/images/Lakshadeep8.webp",
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.diving) specialRequests.push("Scuba Diving");
    if (formData.specialRequests.snorkeling) specialRequests.push("Snorkeling");
    if (formData.specialRequests.kayaking) specialRequests.push("Kayaking");
    if (formData.specialRequests.photography) specialRequests.push("Underwater Photography");
    ...
    const templateParams = {
      ...
      accommodationType: formData.accommodationType === 'resort' ? 'Beach Resort' : 
                       formData.accommodationType === 'homestay' ? 'Local Homestay' : 'Luxury Villa',
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-teal-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              India's tropical paradise with pristine beaches and vibrant coral reefs
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-blue-600 to-teal-600 text-white px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all hover:brightness-110"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">India's Coral Paradise</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover the untouched beauty of Lakshadweep, a group of 36 breathtaking islands in the Arabian Sea. With its white sandy beaches, crystal clear lagoons, and rich marine life, Lakshadweep offers a perfect tropical getaway away from the crowds.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <GiIsland className="text-4xl text-blue-600" />,
              title: "Pristine Islands",
              desc: "Unspoiled tropical islands with powdery white sand beaches"
            },
            {
              icon: <FaSwimmer className="text-4xl text-teal-500" />,
              title: "Marine Life",
              desc: "Vibrant coral reefs teeming with colorful fish and sea turtles"
            },
            {
              icon: <MdDining className="text-4xl text-amber-600" />,
              title: "Island Cuisine",
              desc: "Fresh seafood and unique Laccadivian coconut-based dishes"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Island Packages</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Lakshadweep's islands.
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-blue-600 to-teal-600 text-white px-6 py-2 rounded-lg font-medium shadow-md hover:shadow-lg"
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Island Paradise</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience the breathtaking beauty of Lakshadweep through these stunning visuals.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our Island Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-6 rounded-full"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <GiSailboat className="text-4xl text-blue-600" />,
                title: "Island Transfers",
                desc: "Seamless boat transfers between islands with our expert crew"
              },
              {
                icon: <SiYourtraveldottv className="text-4xl text-amber-600" />,
                title: "Permit Assistance",
                desc: "We handle all required permits for visiting Lakshadweep"
              },
              {
                icon: <GiSeaTurtle className="text-4xl text-green-600" />,
                title: "Eco-Friendly Tours",
                desc: "Sustainable tourism practices to protect marine life"
              },
              {
                icon: <IoMdRestaurant className="text-4xl text-blue-500" />,
                title: "Local Experiences",
                desc: "Authentic island cuisine and cultural interactions"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/lakshadweep-beach.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  {/* Package Info Side */}
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-teal-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/lakshadweep-beach.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      >
                        ...
                        <button
                          onClick={closeBookingModal}
                          className="bg-gradient-to-r from-blue-600 to-teal-600 text-white px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg"
                        >
                          Close
                        </button>
                      </motion.div>
                      ...
                      <>
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your Island Getaway</h3>
                        <p className="text-gray-600 mb-6">Secure your Lakshadweep tour today</p>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="diving"
                                  checked={formData.specialRequests.diving}
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="kayaking"
                                  checked={formData.specialRequests.kayaking}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-blue-600"
                                />
                                <span>Kayaking</span>
