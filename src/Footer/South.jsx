...
import { 
  FaStar, FaCalendarAlt, FaCity, FaUmbrella, FaShoppingBag, 
  FaChevronDown, FaTimes, FaPhone, FaEnvelope, FaMapMarkerAlt, 
  FaPlus, FaMinus, FaLandmark, FaUtensils, FaTheaterMasks,
  FaGlobeAsia, FaMonument
} from 'react-icons/fa';
...
const South = () => {
  ...
  const packages = [
    ...
    },
    {
      ...
      icon: <FaTheaterMasks className="text-2xl text-pink-600" />
    },
    {
      id: 3,
      ...
      icon: <FaMonument className="text-2xl text-green-600" />
    },
    {
      id: 4,
      ...
      icon: <FaUmbrella className="text-2xl text-blue-600" />
    }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.kpop) specialRequests.push("K-Pop Experiences");
    if (formData.specialRequests.hiking) specialRequests.push("Hiking Tours");
    if (formData.specialRequests.cultural) specialRequests.push("Cultural Activities");
    if (formData.specialRequests.food) specialRequests.push("Food Tours");
    ...
    <div className="min-h-screen bg-gradient-to-b from-red-50 to-white">
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Land of Morning Calm</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-white mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Experience South Korea's perfect blend of ancient palaces, cutting-edge technology, 
            mouthwatering cuisine, and vibrant pop culture that's taking the world by storm.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <FaGlobeAsia className="text-4xl text-red-600" />,
              title: "K-Culture Wave",
              desc: "K-Pop, K-Dramas, and Korean beauty trends"
            },
            {
              icon: <FaMonument className="text-4xl text-gray-700" />,
              title: "Ancient Heritage",
              desc: "UNESCO sites and traditional hanok villages"
            },
            {
              icon: <FaUtensils className="text-4xl text-amber-600" />,
              title: "Culinary Delights",
              desc: "From street food to royal court cuisine"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-red-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-white mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover South Korea through our carefully curated experiences blending tradition and modernity.
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      {pkg.type === 'kpop' && 'K-Culture Experience'}
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-red-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Discover South Korea</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-white mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore the vibrant cities, tranquil temples, and stunning landscapes of South Korea.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our South Korea Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-white mx-auto mb-6 rounded-full"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <GiModernCity className="text-4xl text-red-600" />,
                title: "Local Experts",
                desc: "Native guides with insider knowledge"
              },
              {
                icon: <FaTheaterMasks className="text-4xl text-pink-600" />,
                title: "K-Culture Access",
                desc: "Exclusive K-Pop and entertainment experiences"
              },
              {
                icon: <FaMonument className="text-4xl text-green-600" />,
                title: "Cultural Immersion",
                desc: "Authentic traditional experiences"
              },
              {
                icon: <FaUtensils className="text-4xl text-amber-600" />,
                title: "Food Adventures",
                desc: "Guided culinary tours and cooking classes"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/korea-booking.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 bg-gradient-to-b from-red-600 to-white text-red-900 relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/korea-booking.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      <>
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your South Korea Adventure</h3>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-red-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="kpop"
                                  checked={formData.specialRequests.kpop}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-red-600"
                                />
                                <span>K-Pop Experiences</span>
                              </label>
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-red-300 transition-colors">
                                <input
                                  type="checkbox"
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-red-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="food"
                                  checked={formData.specialRequests.food}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-red-600"
                                />
