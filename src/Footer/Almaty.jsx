...
import { 
  ...
  FaPlus, FaMinus, FaCity, FaMountain, FaTree, FaSnowflake,
  FaUtensils
} from 'react-icons/fa';
import { GiMoneyStack, GiNightSky, GiCampingTent } from 'react-icons/gi';
...
const Almaty = () => {
  ...
  const packages = [
    {
      id: 1,
      title: "Almaty City & Mountain Escape",
      duration: "6 Days / 5 Nights",
      price: "₹54,999",
      rating: 4.8,
      image: "/images/Almaty1.jpeg",
      type: "popular",
      highlights: [
        "Explore Almaty's city center and Zenkov Cathedral",
        "Medeu Skating Rink and Shymbulak Ski Resort",
        "Big Almaty Lake day trip",
        "Kok-Tobe Hill with panoramic city views",
        "Green Bazaar for local flavors"
      ],
      icon: <FaStar className="text-2xl text-yellow-500" />
    },
    {
      id: 2,
      title: "Almaty Luxury Experience",
      duration: "5 Days / 4 Nights",
      price: "₹79,999",
      rating: 4.9,
      image: "/images/Almaty2.avif",
      type: "luxury",
      highlights: [
        "5-star accommodations in Almaty",
        "Private guided tours with luxury transport",
        "Gourmet Kazakh cuisine experiences",
        "VIP access to cultural sites",
        "Helicopter tour over the Tian Shan mountains"
      ],
      icon: <GiMoneyStack className="text-2xl text-amber-600" />
    },
    {
      id: 3,
      title: "Almaty Nature & Adventure",
      duration: "7 Days / 6 Nights",
      price: "₹67,999",
      rating: 4.7,
      image: "/images/Almaty3.jpeg",
      type: "adventure",
      highlights: [
        "Hiking in Charyn Canyon",
        "Kolsai Lakes trekking",
        "Skiing at Shymbulak (seasonal)",
        "Altyn-Emel National Park visit",
        "Horseback riding in the mountains"
      ],
      icon: <MdOutlineHiking className="text-2xl text-green-600" />
    },
    {
      id: 4,
      title: "Almaty Cultural Discovery",
      duration: "4 Days / 3 Nights",
      price: "₹44,999",
      rating: 4.5,
      image: "/images/Almaty4.jpeg",
      type: "heritage",
      highlights: [
        "Central State Museum of Kazakhstan",
        "First President's Park",
        "Traditional Kazakh music performance",
        "Aul ethnic village experience",
        "Local craft workshops"
      ],
      icon: <FaCity className="text-2xl text-blue-500" />
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-amber-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Where urban sophistication meets breathtaking mountain landscapes
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-blue-600 to-amber-600 text-white px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all hover:brightness-110"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">The Garden City of Kazakhstan</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-amber-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover Almaty, a vibrant city nestled at the foot of the Tian Shan mountains, offering a perfect blend 
            of Soviet-era architecture, modern Kazakh culture, and stunning natural beauty.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Gateway to the stunning Tian Shan mountain range"
            },
            {
              icon: <FaTree className="text-4xl text-amber-500" />,
              title: "Green City",
              desc: "Known for its tree-lined streets and parks"
            },
            {
              icon: <FaSnowflake className="text-4xl text-red-600" />,
              title: "Winter Sports",
              desc: "World-class skiing at Shymbulak resort"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-amber-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Almaty's urban and natural attractions.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Discover Almaty</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-amber-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore the stunning landscapes, urban attractions, and cultural treasures of Almaty.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Local Experts",
                desc: "Knowledgeable guides with deep cultural insights"
              },
              {
                icon: <FaMapMarkerAlt className="text-4xl text-amber-500" />,
                title: "Authentic Experiences",
                desc: "Access to off-the-beaten-path locations"
              },
              {
                icon: <FaUtensils className="text-4xl text-red-500" />,
                title: "Culinary Adventures",
                desc: "Traditional Kazakh meals with local families"
              },
              {
                icon: <GiCampingTent className="text-4xl text-blue-500" />,
                title: "Comprehensive Itineraries",
                desc: "Carefully crafted to maximize your experience"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/almaty-booking.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  {/* Package Info Side */}
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-amber-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/almaty-booking.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      >
                        ...
                        <button
                          onClick={closeBookingModal}
                          className="bg-gradient-to-r from-blue-600 to-amber-600 text-white px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg"
                        >
                          Close
                        </button>
                      </motion.div>
                      ...
                      <>
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your Almaty Adventure</h3>
