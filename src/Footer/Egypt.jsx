...
import { 
  ...
  FaPlus, FaMinus, FaMonument, FaWater, FaUmbrellaBeach
} from 'react-icons/fa';
...
const Egypt = () => {
  ...
  const packages = [
    ...
    },
    {
      ...
      type: "cruise",
      highlights: [
        "5-star Nile cruise from Luxor to Aswan",
        "Philae Temple visit",
    ...
    },
    {
      ...
      price: "₹58,999",
      rating: 4.7,
      image: "/images/Egypt4.jpeg",
      type: "cultural",
      highlights: [
        "Pyramids sound & light show",
        "Step Pyramid of Djoser",
        "Coptic Cairo & Islamic sites",
        "Abu Simbel temples",
        "Papyrus institute visit"
      ],
      icon: <FaMonument className="text-2xl text-amber-600" />
    },
    {
      id: 4,
      ...
      price: "₹52,999",
      rating: 4.6,
      image: "/images/Egypt5.jpg",
      type: "beach",
      highlights: [
        "Hurghada beach resort stay",
        "Snorkeling in Giftun Islands",
        "Desert safari experience",
        "Dolphin watching cruise",
        "Underwater observatory visit"
      ],
      icon: <FaUmbrellaBeach className="text-2xl text-red-500" />
    }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.nileCruise) specialRequests.push("Nile Cruise");
    if (formData.specialRequests.archaeology) specialRequests.push("Archaeology Tours");
    if (formData.specialRequests.desert) specialRequests.push("Desert Experiences");
    if (formData.specialRequests.diving) specialRequests.push("Diving/Snorkeling");
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-amber-600 to-white text-amber-900 px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all hover:brightness-110"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Land of Pharaohs</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-white mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Step into a world of ancient mysteries, monumental architecture, and rich cultural heritage 
            that has fascinated travelers for centuries.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <FaMonument className="text-4xl text-amber-600" />,
              title: "Ancient Wonders",
              desc: "Pyramids, temples, and royal tombs"
            },
            {
              icon: <FaWater className="text-4xl text-blue-500" />,
              title: "Nile River",
              desc: "Lifeblood of Egypt's civilization"
            },
            {
              icon: <FaUmbrellaBeach className="text-4xl text-yellow-700" />,
              title: "Desert Adventures",
              desc: "Sahara landscapes and oases"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-amber-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-white mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover Egypt's treasures through our carefully crafted itineraries blending history, culture, and adventure.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            {[
              ...
              { id: 'cruise', label: 'Nile Cruise' },
              { id: 'cultural', label: 'Cultural' },
              { id: 'beach', label: 'Red Sea' }
            ].map(tab => (
              <motion.button
                key={tab.id}
                whileHover={{ scale: 1.05 }}
                ...
                className={`px-6 py-2 rounded-full font-medium transition-all ${
                  activeTab === tab.id
                    ? 'bg-gradient-to-r from-amber-600 to-white text-amber-900 shadow-md'
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      {pkg.type === 'cruise' && 'Nile Cruise'}
                      {pkg.type === 'cultural' && 'Cultural Tour'}
                      {pkg.type === 'beach' && 'Red Sea Vacation'}
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-amber-600 to-white text-amber-900 px-6 py-2 rounded-lg font-medium shadow-md hover:shadow-lg"
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-amber-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Discover Egypt</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-white mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore the pyramids, temples, deserts, and waterways that make Egypt one of the world's most fascinating destinations.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our Egypt Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-white mx-auto mb-6 rounded-full"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <GiModernCity className="text-4xl text-amber-600" />,
                title: "Egyptologists",
                desc: "Expert guides with deep knowledge"
              },
              {
                icon: <FaMonument className="text-4xl text-gray-700" />,
                title: "Exclusive Access",
                desc: "Special entry to archaeological sites"
              },
              {
                icon: <FaWater className="text-4xl text-blue-500" />,
                title: "Premium Nile Cruises",
                desc: "Luxury ships with private balconies"
              },
              {
                icon: <FaUmbrellaBeach className="text-4xl text-yellow-700" />,
                title: "Desert Experiences",
                desc: "Authentic Bedouin encounters"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/egypt-booking.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  {/* Package Info Side */}
                  <div className="p-8 bg-gradient-to-b from-amber-600 to-white text-amber-900 relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/egypt-booking.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      >
                        ...
                        <button
                          onClick={closeBookingModal}
                          className="bg-gradient-to-r from-amber-600 to-white text-amber-900 px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg"
                        >
                          Close
                        </button>
                      </motion.div>
                      ...
                      <>
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your Egypt Adventure</h3>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-amber-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="nileCruise"
                                  checked={formData.specialRequests.nileCruise}
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-amber-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="archaeology"
                                  checked={formData.specialRequests.archaeology}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-amber-600"
                                />
                                <span>Archaeology Tours</span>
                              </label>
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-amber-300 transition-colors">
                                <input
                                  type="checkbox"
                          ...
                          <div className="pt-2">
                            <motion.button
                              ...
                              className={`w-full py-4 px-6 rounded-xl font-bold text-white shadow-lg transition-all ${
                                isSubmitting
                                  ? 'bg-gray-400'
                                  : 'bg-gradient-to-r from-amber-600 to-white text-amber-900 hover:from-amber-700'
                              }`}
                            >
                              {isSubmitting ? (
