                ...
                {expandedTrip === trip.id && (
                  ...
                  >
                    <div className="border-t border-gray-100 pt-4 mt-4">
                      <h4 className="font-bold text-gray-800 mb-3">Group Trip Highlights:</h4>
                      ...
                      <h4 className="font-bold text-gray-800 mb-2">Available Group Dates:</h4>
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="w-full bg-gradient-to-r from-purple-600 to-pink-500 text-white py-3 rounded-lg font-medium hover:from-purple-700 hover:to-pink-600 transition-all shadow-md hover:shadow-lg"
                      >
