...
import { GiWaterfall, GiVillage, GiRiver } from 'react-icons/gi';
...
const Uttarakhand = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.yogaMeditation) specialRequests.push("Yoga & Meditation");
    if (formData.specialRequests.wildlifeSafari) specialRequests.push("Wildlife Safari");
    if (formData.specialRequests.pilgrimage) specialRequests.push("Pilgrimage");
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-green-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Where the Himalayas meet spirituality, adventure, and natural wonders
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Uttarakhand - Devbhumi</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Uttarakhand, known as the "Land of the Gods", is a mystical Himalayan state that offers sacred pilgrimage sites, breathtaking mountain landscapes, thrilling adventure sports, and rich biodiversity. It's where spirituality meets adventure amidst snow-capped peaks.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Home to India's highest peaks including Nanda Devi and Trishul"
            },
            {
              icon: <GiWaterfall className="text-4xl text-green-500" />,
              title: "Sacred Rivers",
              desc: "Source of the Ganga and Yamuna, India's most revered rivers"
            },
            {
              icon: <MdOutlineHiking className="text-4xl text-blue-700" />,
              title: "Adventure Capital",
              desc: "Trekking, rafting, skiing, and more in the adventure paradise"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Uttarakhand Tour Packages</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Uttarakhand, from spiritual journeys to adventurous treks.
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      {pkg.type === 'winter' && 'Winter Special'}
                      {pkg.type === 'pilgrimage' && 'Pilgrimage Tour'}
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Glimpses of Uttarakhand</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Witness the breathtaking beauty of Uttarakhand through these stunning visuals that capture its essence.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our Uttarakhand Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6 rounded-full"></div>
          </div>
            ...
            {[
              {
                ...
                desc: "Our guides are Uttarakhand natives who know every hidden trail and sacred site"
              },
              {
                icon: <FaTree className="text-4xl text-green-500" />,
                title: "Eco-Tourism Focus",
                desc: "Sustainable tourism that supports mountain communities and preserves nature"
              },
              {
                icon: <MdOutlineHiking className="text-4xl text-blue-700" />,
                title: "Adventure Specialists",
                desc: "Expert-led treks and adventure activities with top safety standards"
              },
              {
                icon: <GiRiver className="text-4xl text-green-400" />,
                title: "Spiritual Guidance",
                desc: "Authentic experiences with priests and spiritual leaders at sacred sites"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/Uttarakhand5.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-green-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/Uttarakhand5.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      <>
                        ...
                        <p className="text-gray-600 mb-6">Secure your Uttarakhand adventure today</p>
