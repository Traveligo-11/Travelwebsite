...
import { 
  ...
  FaPlus, FaMinus, FaWater, FaTree, FaHiking, FaSnowflake
} from 'react-icons/fa';
import { GiKiwiBird, GiMountainRoad, GiCampfire } from 'react-icons/gi';
import { MdOutlineKayaking, MdFamilyRestroom, MdFlight } from 'react-icons/md';
...
const NewZealand = () => {
  ...
  const packages = [
    {
      id: 1,
      title: "Classic New Zealand Explorer",
      duration: "12 Days / 11 Nights",
      price: "₹1,49,999",
      rating: 4.9,
      image: "/images/Newzealand2.jpg",
      type: "popular",
      highlights: [
        "Auckland city tour including Sky Tower",
        "Waitomo Glowworm Caves experience",
        "Hobbiton Movie Set visit",
        "Rotorua geothermal wonders",
        "Tongariro National Park adventure",
        "Wellington cultural highlights",
        "Queenstown and Fiordland exploration",
    ...
    {
      id: 3,
      title: "Luxury South Island Escape",
      duration: "8 Days / 7 Nights",
      price: "₹2,49,999",
      rating: 4.7,
      image: "/images/Newzealand4.jpg",
      type: "luxury",
      highlights: [
        "5-star lodges with mountain views",
        "Private helicopter tour of Milford Sound",
        "Wine tasting in Marlborough region",
        "Exclusive Maori cultural experience",
        "Gourmet dining with local produce",
        "Private guided tours",
        "Luxury coach transfers"
      ],
      icon: <GiCampfire className="text-2xl text-amber-600" />
    },
    {
      id: 4,
      title: "Family Fun in Middle Earth",
      duration: "14 Days / 13 Nights",
      price: "₹1,89,999",
      rating: 4.6,
      image: "/images/Newzealand5.webp",
      type: "family",
      highlights: [
        "Hobbiton Movie Set family tour",
        "Rainbow Springs Nature Park",
        "Wellington's Te Papa Museum",
        "Christchurch International Antarctic Centre",
        "Dunedin's Wildlife Cruise",
        "Queenstown family-friendly activities",
  ...
  const galleryImages = [
   ...
   "/images/Newzealand3.jpg",
    ...
    "/images/Newzealand5.webp",
    "/images/Newzealand6.jpeg",
    "/images/Newzealand7.webp",
    "/images/Newzealand8.jpeg",
    "/images/Newzeland1.jpeg",
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.wildlife) specialRequests.push("Wildlife Experiences");
    if (formData.specialRequests.luxury) specialRequests.push("Luxury Accommodation");
    if (formData.specialRequests.family) specialRequests.push("Family-Friendly");
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-blue-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Where breathtaking landscapes meet thrilling adventures
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Middle Earth Awaits</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-green-500 to-blue-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            New Zealand's dramatic landscapes range from soaring mountains and glaciers to lush forests 
            and pristine beaches. Experience Maori culture, world-class adventure sports, and the famous 
            Kiwi hospitality in this island paradise.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "From Fiordland to the Southern Alps"
            },
            {
              icon: <FaHiking className="text-4xl text-blue-500" />,
              title: "Adventure Capital",
              desc: "Birthplace of bungee jumping and jet boating"
            },
            {
              icon: <GiKiwiBird className="text-4xl text-amber-600" />,
              title: "Unique Wildlife",
              desc: "Kiwi birds, penguins, and marine mammals"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-green-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-green-500 to-blue-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of New Zealand.
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      {pkg.type === 'adventure' && 'Adventure Package'}
                      {pkg.type === 'luxury' && 'Luxury Experience'}
                      {pkg.type === 'family' && 'Family Holiday'}
                    </div>
                  </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-green-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">New Zealand's Wonders</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-green-500 to-blue-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Witness the breathtaking beauty of New Zealand through these stunning visuals.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <GiMountainRoad className="text-4xl text-green-600" />,
                title: "Local Experts",
                desc: "Kiwi guides with deep knowledge of the land"
              },
              {
                icon: <MdFlight className="text-4xl text-blue-500" />,
                title: "Seamless Logistics",
                desc: "Domestic flights and transfers included"
              },
              {
                icon: <GiKiwiBird className="text-4xl text-amber-600" />,
                title: "Authentic Experiences",
                desc: "Maori cultural encounters and wildlife"
              },
              {
                icon: <GiCampfire className="text-4xl text-green-500" />,
                title: "Quality Accommodation",
                desc: "From luxury lodges to wilderness stays"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/nz-landscape.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 bg-gradient-to-b from-green-600 to-blue-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/nz-landscape.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      <>
                        ...
                        <p className="text-gray-600 mb-6">Secure your New Zealand tour today</p>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-green-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="luxury"
                                  checked={formData.specialRequests.luxury}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-green-600"
                                />
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-green-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="family"
                                  checked={formData.specialRequests.family}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-green-600"
                                />
