...
import { FaMapMarkerAlt, FaPlay, FaPause, FaVolumeUp, FaVolumeMute, FaQuoteLeft } from 'react-icons/fa';
...
const clientTestimonials = [
  {
    ...
    role: 'Solo Traveler',
    videoUrl: Debashree,Debashree1,
    thumbnail: '/images/Debashree.jpg',
    location: 'Kashmir, India',
    quote: "Traveling solo through Kashmir was a transformative experience.",
    type: 'solo',
    duration: '7 days',
...
const VideoPlayer = React.forwardRef(({ videoUrl, thumbnail, isPlaying, onPlayToggle, isMuted, onMuteToggle }, ref) => {
  return (
    <div className="overflow-hidden shadow-2xl relative h-[750px] w-90 ">
      <video
        ref={ref}
        src={videoUrl}
        poster={thumbnail}
                ...
                <div className="p-10">
                  <div className="flex flex-col md:flex-row gap-8">
                    <div className="md:w-2/3">
                      <div className="mb-6">
                        <h3 className="text-3xl font-bold text-gray-800">{testimonial.name}</h3>
                        <div className="flex items-center mt-3 space-x-4">
                          <span className="text-gray-500 font-medium">{testimonial.role}</span>
                          <span className="text-gray-400">•</span>
                          <div className="flex items-center text-gray-500">
                            <FaMapMarkerAlt className="mr-2 text-pink-500" size={18} />
                      ...
                      <div className="relative mb-8">
                        <FaQuoteLeft className="absolute -left-8 top-0 text-pink-300 text-3xl" />
                        <p className="text-gray-700 text-xl pl-6 italic font-serif leading-relaxed">"{testimonial.quote}"</p>
                      </div>
                    </div>

                    <div className="md:w-1/3">
                      <div className="bg-pink-50 rounded-xl p-6 border border-pink-100 h-full">
                        <h4 className="font-bold text-pink-600 text-lg mb-4">Trip Highlights</h4>
                        ...
                        <div className="mt-6 pt-4 border-t border-pink-200">
                          <div className="flex justify-between">
                            <div>
                              ...
                              <p className="text-base font-bold text-gray-800">{testimonial.duration}</p>
                            </div>
                            <div>
                              <p className="text-xs text-gray-500 font-medium">Trip Type</p>
                              <p className="text-base font-bold text-gray-800 capitalize">{testimonial.type}</p>
                            </div>
                          </div>
                        </div>
                      </div>
