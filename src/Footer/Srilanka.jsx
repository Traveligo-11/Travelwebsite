...
import { 
  ...
  FaGlobeAsia, FaMonument, FaWater, FaMountain
} from 'react-icons/fa';
import { GiMoneyStack, GiModernCity, GiElephant } from 'react-icons/gi';
import { MdFamilyRestroom, MdBeachAccess } from 'react-icons/md';
...
const SriLanka = () => {
  ...
  const packages = [
    ...
    },
    {
      ...
      icon: <MdBeachAccess className="text-2xl text-blue-500" />
    }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.wildlife) specialRequests.push("Wildlife Safaris");
    if (formData.specialRequests.beaches) specialRequests.push("Beach Activities");
    if (formData.specialRequests.cultural) specialRequests.push("Cultural Experiences");
    if (formData.specialRequests.ayurveda) specialRequests.push("Ayurvedic Treatments");
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              The teardrop island of endless wonders
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Pearl of the Indian Ocean</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-white mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover Sri Lanka's ancient cities, golden beaches, misty highlands, and abundant wildlife 
            in this compact island paradise that packs endless diversity.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Ancient cities and sacred Buddhist sites"
            },
            {
              icon: <GiElephant className="text-4xl text-gray-700" />,
              title: "Wildlife Wonders",
              desc: "Elephants, leopards, and whale watching"
            },
            {
              icon: <MdBeachAccess className="text-4xl text-amber-600" />,
              title: "Beach Paradise",
              desc: "Pristine beaches and turquoise waters"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-white mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience the best of Sri Lanka with our carefully curated tours showcasing the island's diverse attractions.
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      {pkg.type === 'wildlife' && 'Wildlife Experience'}
                      {pkg.type === 'cultural' && 'Cultural Tour'}
                      {pkg.type === 'beach' && 'Beach Vacation'}
                    </div>
                  </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Discover Sri Lanka</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-white mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore the ancient cities, wildlife parks, tea plantations, and pristine beaches of Sri Lanka.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our Sri Lanka Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-white mx-auto mb-6 rounded-full"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <GiModernCity className="text-4xl text-blue-600" />,
                title: "Local Experts",
              ...
              },
              {
                ...
                desc: "Expert naturalists for safaris"
              },
              {
                icon: <FaMonument className="text-4xl text-green-600" />,
                title: "Cultural Immersion",
                desc: "Authentic local experiences"
              },
              {
                icon: <MdBeachAccess className="text-4xl text-teal-500" />,
                title: "Beach Resorts",
                desc: "Carefully selected coastal stays"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/srilanka-booking.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-white text-blue-900 relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/srilanka-booking.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      <>
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your Sri Lanka Adventure</h3>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="beaches"
                                  checked={formData.specialRequests.beaches}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-blue-600"
                                />
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="ayurveda"
                                  checked={formData.specialRequests.ayurveda}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-blue-600"
                                />
