...
import { 
  FaStar, FaCalendarAlt, FaHome, FaUmbrella, FaShoppingBag, 
  FaChevronDown, FaTimes, FaPhone, FaEnvelope, FaMapMarkerAlt, 
  FaPlus, FaMinus, FaCity, FaShip, FaUtensils, FaBuilding,
  FaMountain, FaTree, FaLeaf
} from 'react-icons/fa';
import { GiMoneyStack, GiNightSky } from 'react-icons/gi';
import { MdCasino, MdOutlineHiking, MdFamilyRestroom, MdTempleBuddhist } from 'react-icons/md';
...
const Japan = () => {
  ...
  const packages = [
    {
      ...
      type: "popular",
      highlights: [
        "Tokyo city tour with Shibuya Crossing",
        "Kyoto's Golden Pavilion and Fushimi Inari Shrine",
        "Bullet train experience to Osaka",
        "Traditional ryokan stay with onsen",
    ...
    },
    {
      ...
      icon: <GiMoneyStack className="text-2xl text-amber-600" />
    },
    {
      id: 3,
      title: "Family Adventure Japan",
      duration: "14 Days / 13 Nights",
      price: "₹1,79,999",
      rating: 4.8,
      image: "/images/Japan3.webp",
      type: "family",
      highlights: [
        "Tokyo Disneyland and DisneySea",
        "Universal Studios Japan",
        "Interactive samurai experience",
        "Kid-friendly cultural activities",
        "Child-focused dining options"
      ],
      icon: <MdFamilyRestroom className="text-2xl text-blue-500" />
    },
    {
      id: 4,
      ...
      price: "₹1,59,999",
      rating: 4.7,
      image: "/images/Japan4.png",
      type: "heritage",
      highlights: [
        "Tea ceremony with master",
        "Zen meditation in Kyoto temples",
        "Traditional crafts workshops",
        "Stay in historic ryokan",
        "UNESCO World Heritage sites"
      ],
      icon: <MdTempleBuddhist className="text-2xl text-green-600" />
    }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.dining) specialRequests.push("Fine Dining");
    if (formData.specialRequests.nightlife) specialRequests.push("Nightlife");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-red-50">
      {/* Hero Section */}
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-purple-600 to-red-600 text-white px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all hover:brightness-110"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Land of the Rising Sun</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-red-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover Japan's perfect harmony of ancient temples and futuristic cities, 
            serene gardens and neon-lit streets, traditional tea ceremonies and cutting-edge technology.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <MdTempleBuddhist className="text-4xl text-purple-600" />,
              title: "Cultural Heritage",
              desc: "Centuries-old temples, shrines, and traditional arts"
            },
            {
              icon: <FaMountain className="text-4xl text-red-500" />,
              title: "Natural Beauty",
              desc: "Cherry blossoms, majestic Mount Fuji, and serene gardens"
            },
            {
              icon: <FaShoppingBag className="text-4xl text-amber-600" />,
              title: "Modern Wonders",
              desc: "High-tech cities, bullet trains, and futuristic architecture"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
              ...
              className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow text-center border border-gray-100 hover:border-purple-200"
            >
      ...
      {/* Packages Section */}
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-purple-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Tour Packages</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-red-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Japan.
            </p>
          </div>
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4">
                    <div className="bg-purple-600/90 text-white px-3 py-1 rounded-full text-sm font-medium">
                      {pkg.duration}
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-purple-600 to-red-600 text-white px-6 py-2 rounded-lg font-medium shadow-md hover:shadow-lg"
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-purple-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Glimpses of Japan</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-red-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover the beauty and diversity of Japan through these stunning visuals.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our Japan Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-red-500 mx-auto mb-6 rounded-full"></div>
          </div>
            ...
            {[
              {
                ...
                title: "Japan Specialists",
                desc: "Guides with deep cultural knowledge"
              },
              {
                icon: <IoMdTrain className="text-4xl text-red-500" />,
                title: "Seamless Transport",
                desc: "Including Japan Rail Pass where applicable"
              },
              {
                icon: <FaLeaf className="text-4xl text-green-500" />,  // Replaced GiCherryBlossom with FaLeaf
                title: "Seasonal Experiences",
                desc: "Cherry blossoms, autumn leaves, and more"
              },
              {
                icon: <FaUtensils className="text-4xl text-purple-500" />,
                title: "Authentic Dining",
                desc: "From sushi to kaiseki to izakaya"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/japan-booking.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  {/* Package Info Side */}
                  <div className="p-8 bg-gradient-to-b from-purple-600 to-red-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/japan-booking.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      >
                        ...
                        <button
                          onClick={closeBookingModal}
                          className="bg-gradient-to-r from-purple-600 to-red-600 text-white px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg"
                        >
                          Close
                        </button>
                      </motion.div>
                      ...
                      <>
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your Japan Adventure</h3>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <input
                                ...
                                required
                                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all bg-white/70"
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              >
                                ...
                                <option value="ryokan">Traditional Ryokan</option>
                          ...
                          <div className="bg-purple-50/70 p-4 rounded-lg border border-purple-100">
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-purple-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="shopping"
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-purple-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="dining"
                                  checked={formData.specialRequests.dining}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-purple-600"
                                />
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-purple-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="nightlife"
                                  checked={formData.specialRequests.nightlife}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-purple-600"
                                />
                                <span>Nightlife</span>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all bg-white"
                            />
                          </div>
                          ...
                          <p className="text-xs text-gray-500 text-center">
                            By submitting this form, you agree to our <a href="#" className="text-purple-600 hover:underline">Terms of Service</a> and <a href="#" className="text-purple-600 hover:underline">Privacy Policy</a>.
                          </p>
                        </form>
                      </>
                    )}
