...
import { MdCasino, MdOutlineHiking, MdFamilyRestroom } from 'react-icons/md';
...
const Hong = () => {
  ...
  const packages = [
    {
      id: 1,
      title: "Hong Kong & Macao Highlights",
      ...
      highlights: [
        ...
        "Macao Tower and Historic Center",
    ...
    },
    {
      ...
      price: "₹89,999",
      rating: 4.9,
      image: "/images/Hong2.jpeg",
      type: "luxury",
      highlights: [
        "5-star harbor view accommodations",
        "Private limousine transfers",
        "Michelin-star dining experiences",
        "Exclusive shopping concierge",
    ...
    },
    {
      ...
      price: "₹58,999",
      rating: 4.6,
      image: "/images/Hong4.jpeg",
      type: "heritage",
      highlights: [
        "Man Mo Temple and Tai O fishing village",
        "Macao's UNESCO heritage sites",
        "Traditional dim sum making class",
        "Temple Street Night Market",
        "Colonial architecture tour"
      ],
      icon: <FaBuilding className="text-2xl text-green-600" /> // Replaced GiSkyscraper with FaBuilding
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-red-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Where East meets West in a dazzling fusion of culture and modernity
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">East Meets West</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-red-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Experience the vibrant energy of Hong Kong's skyscrapers and the Portuguese charm of Macao. 
            From dazzling cityscapes to world-class cuisine, these dynamic destinations offer unforgettable experiences.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <FaBuilding className="text-4xl text-purple-600" />, // Replaced GiSkyscraper with FaBuilding
              title: "Urban Wonders",
              desc: "Iconic skylines, neon-lit streets, and breathtaking city views"
            },
            {
              icon: <FaShoppingBag className="text-4xl text-red-500" />,
              title: "Shopping Paradise",
              desc: "From luxury malls to bustling street markets"
            },
            {
              icon: <FaUtensils className="text-4xl text-amber-600" />,
              title: "Culinary Capital",
              desc: "Michelin-starred restaurants to authentic street food"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-purple-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-red-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Hong Kong and Macao.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-purple-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Glimpses of Hong Kong & Macao</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-red-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover the vibrant energy and unique blend of cultures through these stunning visuals.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Local Experts",
                desc: "Knowledgeable guides with insider access"
              },
              {
                icon: <MdCasino className="text-4xl text-red-500" />,
                title: "Exclusive Access",
                desc: "Priority entry to top attractions and shows"
              },
              {
                icon: <FaShip className="text-4xl text-blue-500" />,
                title: "Seamless Transport",
                desc: "All intercity transfers and ferry tickets included"
              },
              {
                icon: <GiNightSky className="text-4xl text-purple-500" />,
                title: "Nightlife Access",
                desc: "VIP entry to top clubs and bars"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/hk-booking.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 bg-gradient-to-b from-purple-600 to-red-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/hk-booking.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      <>
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your Hong Kong & Macao Adventure</h3>
