...
import { 
  ...
  FaPlus, FaMinus, FaMountain, FaWater, FaTree, FaCoffee
} from 'react-icons/fa';
import { GiPlantRoots, GiTeapot } from 'react-icons/gi';
...
const Bangalore = () => {
  ...
  const packages = [
    {
      id: 1,
      title: "Golden Triangle of South India",
      duration: "6 Days / 5 Nights",
      price: "₹24,999",
      rating: 4.8,
      image: "/images/Banglore1.jpeg",
      type: "popular",
      highlights: [
        "Explore Bangalore's tech parks and historical sites",
        "Visit Mysore Palace and Chamundi Hills",
        "Toy Train ride from Mettupalayam to Ooty",
        "Tea plantation tour in Ooty",
        "Visit Brindavan Gardens and St. Philomena's Church"
      ],
    ...
    },
    {
      ...
      price: "₹21,999",
      rating: 4.7,
      image: "/images/Banglore2.jpg",
      type: "heritage",
      highlights: [
        "Detailed tour of Mysore Palace",
        "Visit Tipu Sultan's Summer Palace",
        "Explore Bangalore Fort and Bull Temple",
        "Cultural show in Mysore",
        "Visit Ooty Botanical Gardens"
      ],
      icon: <MdTempleHindu className="text-2xl text-amber-700" />
    },
    {
      id: 3,
      ...
      highlights: [
        ...
        "Explore Coonoor and Wellington"
      ],
    ...
    },
    {
      ...
      price: "₹32,999",
      rating: 4.5,
      image: "/images/Banglore4.jpeg",
      type: "luxury",
      highlights: [
        "Stay at 5-star heritage properties",
        "Private guided tours",
        "Gourmet dining experiences",
        "Spa treatments with mountain views",
        "Personalized itinerary"
      ],
      icon: <FaCoffee className="text-2xl text-amber-600" />
    }
  ];

  const galleryImages = [
   "/images/Banglore1.jpeg",
    "/images/Banglore2.jpg",
    "/images/Banglore3.jpg",
    "/images/Banglore4.jpeg",
    "/images/Banglore5.jpg",
    "/images/Banglore6.jpg",
    "/images/Banglore7.jpg",
    "/images/Banglore8.jpeg",
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-green-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <img 
          src="/images/Banglore2.jpg"
          alt="Bangalore Mysore Ooty" 
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              From bustling IT hubs to royal palaces and misty hill stations
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">The Golden Triangle of South India</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Experience the perfect blend of urban energy, royal heritage, and natural beauty on this classic South Indian circuit. From Bangalore's tech parks to Mysore's palaces and Ooty's tea gardens, this journey showcases Karnataka and Tamil Nadu's diverse attractions.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <MdTempleHindu className="text-4xl text-blue-600" />,
              title: "Cultural Heritage",
              desc: "Explore royal palaces, ancient temples, and colonial architecture"
            },
            {
              icon: <FaMountain className="text-4xl text-green-500" />,
              title: "Natural Beauty",
              desc: "Misty hills, tea plantations, and scenic valleys of the Nilgiris"
            },
            {
              icon: <FaCoffee className="text-4xl text-amber-700" />,
              title: "Gastronomic Delights",
              desc: "From Mysore pak to filter coffee and Ooty chocolates"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Bangalore, Mysore and Ooty.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Glimpses of the Journey</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Witness the diverse beauty of Bangalore, Mysore and Ooty through these stunning visuals.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Iconic Toy Train",
                desc: "Exclusive arrangements for the famous Nilgiri Mountain Railway"
              },
              {
                icon: <SiYourtraveldottv className="text-4xl text-amber-600" />,
                title: "Skip-the-Line Access",
                desc: "Priority entry to Mysore Palace and other major attractions"
              },
              {
                icon: <GiTeapot className="text-4xl text-green-600" />,
                title: "Authentic Experiences",
                desc: "Tea tasting, silk shopping, and local cuisine experiences"
              },
              {
                icon: <FaHome className="text-4xl text-blue-500" />,
                title: "Quality Accommodation",
                desc: "Carefully selected hotels and heritage properties"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/ooty-tea-gardens.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-green-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/ooty-tea-gardens.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      <>
                        ...
                        <p className="text-gray-600 mb-6">Secure your Bangalore-Mysore-Ooty tour today</p>
