...
import { 
  ...
  FaBus, FaTrain, FaPlane, FaSun, FaMosque
} from 'react-icons/fa';
import { GiModernCity, GiCastle, GiShoppingBag, GiAncientColumns } from 'react-icons/gi';
import { MdOutlineBeachAccess, MdFamilyRestroom, MdSpa } from 'react-icons/md';
...
const Turkey = () => {
  ...
  const packages = [
    {
      ...
      price: "₺25,999",
      rating: 4.9,
      image: "/images/Turkey1.jpeg",
      type: "popular",
      highlights: [
        "Istanbul city tour with Hagia Sophia and Blue Mosque",
        "Cappadocia hot air balloon experience",
        "Ephesus ancient city visit",
        "Pamukkale thermal pools",
        "Bosphorus cruise in Istanbul",
        "Troy archaeological site",
        "Traditional Turkish dinner with show"
      ],
      icon: <FaStar className="text-2xl text-yellow-500" />
    },
    {
      id: 2,
      title: "Luxury Turkey Experience",
      duration: "8 Days / 7 Nights",
      price: "₺45,999",
      rating: 4.8,
      image: "/images/Turkey2.jpeg",
      type: "luxury",
      highlights: [
        "5-star boutique hotels in Istanbul and Cappadocia",
        "Private guided tours with skip-the-line access",
        "Helicopter tour over Cappadocia",
        "Private yacht cruise on Bosphorus",
        "Hammam spa experience",
        "Gourmet Turkish cuisine with wine pairing",
    ...
    },
    {
      ...
      price: "₺18,999",
      rating: 4.7,
      image: "/images/Turkey3.jpeg",
      type: "family",
      highlights: [
        "Istanbul Aquarium and Miniaturk",
        "Cappadocia fairy chimneys exploration",
        "Antalya beach resort stay",
        "Dolphin show in Marmaris",
        "Kid-friendly museums and activities",
    ...
    {
      id: 4,
      title: "Turkish Riviera Beach Holiday",
      duration: "8 Days / 7 Nights",
      price: "₺22,999",
      rating: 4.6,
      image: "/images/Turkey4.jpeg",
      type: "beach",
      highlights: [
        "Antalya all-inclusive beach resort",
        "Boat trip to Kekova sunken city",
        "Oludeniz paragliding experience",
        "Patara Beach - one of Turkey's longest",
        "Ancient ruins of Phaselis",
        "Water sports activities",
        "Relaxing spa treatments"
      ],
      icon: <MdOutlineBeachAccess className="text-2xl text-teal-500" />
    }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.historical) specialRequests.push("Historical Sites");
    if (formData.specialRequests.beach) specialRequests.push("Beach Activities");
    ...
    const templateParams = {
      ...
      accommodationType: formData.accommodationType === 'hotel' ? 'Hotel' : 
                       ...
                       formData.accommodationType === 'cave' ? 'Cave Hotel' : 'Other',
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Where East meets West in a tapestry of history and beauty
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Experience Turkey's Wonders</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            From the ancient ruins of Ephesus to the fairy chimneys of Cappadocia, from Istanbul's vibrant bazaars to the turquoise coasts of the Mediterranean, Turkey offers an unforgettable blend of history, culture, and natural beauty.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <FaMosque className="text-4xl text-blue-600" />,
              title: "Historical Treasures",
              desc: "Hagia Sophia, Ephesus, Pamukkale, and more"
            },
            {
              icon: <MdOutlineBeachAccess className="text-4xl text-teal-500" />,
              title: "Stunning Beaches",
              desc: "Antalya, Bodrum, Oludeniz, and Fethiye"
            },
            {
              icon: <IoMdRestaurant className="text-4xl text-amber-600" />,
              title: "Culinary Delights",
              desc: "Kebabs, baklava, Turkish coffee, and meze"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Turkey Tour Packages</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Turkey.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Turkey Through the Lens</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover the diverse beauty of Turkey from bustling cities to serene landscapes.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our Turkey Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6 rounded-full"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <GiAncientColumns className="text-4xl text-amber-600" />,
                title: "Expert Guides",
                desc: "Knowledgeable about Turkey's rich history"
              },
              {
                icon: <FaTrain className="text-4xl text-blue-600" />,
                title: "Comfortable Transport",
                desc: "Between all major destinations"
              },
              {
                icon: <IoMdRestaurant className="text-4xl text-red-500" />,
                title: "Authentic Cuisine",
                desc: "Taste the best of Turkish food"
              },
              {
                icon: <FaSun className="text-4xl text-yellow-500" />,
                title: "Tailored Experiences",
                desc: "Customized to your interests"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/turkey-bg.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-purple-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/turkey-bg.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                    <div className="relative z-10">
                      ...
                      <div className="mt-6 space-y-3">
                        ...
                        <div className="flex items-center">
                          ...
                          <span>info@turkeytours.com</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      <>
                        ...
                        <p className="text-gray-600 mb-6">Secure your Turkey tour today</p>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              >
                                ...
                                <option value="cave">Cave Hotel</option>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="historical"
                                  checked={formData.specialRequests.historical}
