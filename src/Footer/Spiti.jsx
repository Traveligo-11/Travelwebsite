...
import { 
  ...
  FaPlus, FaMinus, FaPlaceOfWorship 
} from 'react-icons/fa';
...
const Spiti = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.bikeRental) specialRequests.push("Bike Rental");
    ...
    const templateParams = {
      ...
      accommodationType: formData.accommodationType === 'homestay' ? 'Homestay' : 
                       formData.accommodationType === 'hotel' ? 'Hotel' : 'Camping',
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-amber-50">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-blue-600 to-amber-600 text-white px-8 py-4 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">The Last Shangri-La</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-amber-500 mx-auto mb-6"></div>
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Spiti Valley Tour Packages</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-amber-500 mx-auto mb-6"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-blue-600 to-amber-600 text-white px-6 py-2 rounded-lg font-medium"
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Glimpses of Spiti Valley</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-amber-500 mx-auto mb-6"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our Spiti Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-amber-500 mx-auto mb-6"></div>
          </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-70 backdrop-blur-sm">
            ...
            >
              ...
              <div className="grid md:grid-cols-2">
                {/* Package Info Side */}
                <div className="p-8 bg-gradient-to-b from-blue-600 to-blue-800 text-white relative overflow-hidden">
                  <div className="absolute inset-0 bg-[url('/images/Spiti5.avif')] bg-cover bg-center opacity-20"></div>
                ...
                <div className="p-8 bg-white">
                  {submitSuccess ? (
                    ...
                    >
                      ...
                      <button
                        onClick={closeBookingModal}
                        className="bg-gradient-to-r from-blue-600 to-amber-600 text-white px-6 py-3 rounded-lg font-medium"
                      >
                        Close
                      </button>
                    </motion.div>
                    ...
                    <>
                      ...
                      <p className="text-gray-600 mb-6">Secure your Spiti adventure today</p>
