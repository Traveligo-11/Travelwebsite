...
const Kazakhstan = () => {
  ...
  const packages = [
    {
      id: 1,
      title: "Best of Kazakhstan",
      duration: "10 Days / 9 Nights",
      price: "₸450,000",
      rating: 4.9,
      image: "/images/Kazakistan1.jpg",
      type: "popular",
      highlights: [
        "Almaty city tour with Kok-Tobe",
        "Charyn Canyon exploration",
        "Big Almaty Lake visit",
        "Astana (Nur-Sultan) city highlights",
        "Burabay National Park",
        "Shymbulak Mountain Resort",
        "Traditional Kazakh cultural experiences"
      ],
      icon: <FaStar className="text-2xl text-yellow-500" />
    },
    {
      id: 2,
      title: "Luxury Kazakhstan Experience",
      duration: "8 Days / 7 Nights",
      price: "₸650,000",
      rating: 4.8,
      image: "/images/Kazakistan2.avif",
      type: "luxury",
      highlights: [
        "5-star accommodation in Almaty and Nur-Sultan",
        "Private guided tours",
        "Fine dining at top restaurants",
        "VIP access to attractions",
        "Helicopter tour over Almaty",
    ...
    },
    {
      ...
      price: "₸550,000",
      rating: 4.6,
      image: "/images/Kazakistan4.jpg",
      type: "adventure",
      highlights: [
        "Hiking in Altai Mountains",
        "Kaindy Lake exploration",
      ...
      icon: <FaMountain className="text-2xl text-teal-500" />
    }
  ];

  const galleryImages = [
    "/images/Kazakistan1.jpg",
     "/images/Kazakistan2.avif",
    "/images/Kazakistan3.jpeg",
    "/images/Kazakistan4.jpg",
    "/images/Kazakistan5.jpeg",
    "/images/Kazakistan6.jpeg",
    "/images/Kazakistan7.jpeg",
    "/images/Kazakistan8.jpeg",
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Where endless steppes meet modern cities
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">The Heart of Central Asia</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Experience the vast landscapes, rich nomadic heritage, and modern cities of Kazakhstan. 
            From the soaring Tian Shan mountains to the futuristic capital of Nur-Sultan, 
            Kazakhstan offers a unique blend of nature, culture, and innovation.
          </p>
        </div>
          ...
          {[
            {
              ...
              title: "Modern Cities",
              desc: "Almaty, Nur-Sultan, and Shymkent with their unique architecture"
            },
            {
              icon: <FaMountain className="text-4xl text-teal-500" />,
              title: "Stunning Nature",
              desc: "Charyn Canyon, Kolsai Lakes, and Altai Mountains"
            },
            {
              icon: <FaLandmark className="text-4xl text-purple-600" />,
              title: "Rich Culture",
              desc: "Nomadic traditions, Kazakh cuisine, and Silk Road heritage"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Kazakhstan.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Discover Kazakhstan</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Witness the diverse beauty of Kazakhstan through these stunning visuals.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Comfortable transport across vast distances"
              },
              {
              ...
              },
              {
                ...
                desc: "From city tours to wilderness adventures"
              },
              {
                icon: <FaCity className="text-4xl text-blue-500" />,
                title: "Authentic Stays",
                desc: "From yurts to luxury hotels"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/kazakhstan-bg.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-purple-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/kazakhstan-bg.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                    <div className="relative z-10">
                      ...
                      <div className="mt-6 space-y-3">
                        ...
                        <div className="flex items-center">
                          ...
                          <span>info@kazakhtravel.kz</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      <>
                        ...
                        <p className="text-gray-600 mb-6">Secure your Kazakhstan tour today</p>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              >
                                ...
                                <option value="yurt">Traditional Yurt</option>
                              </select>
                            </div>
                            <div>
