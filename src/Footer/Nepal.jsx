...
import { 
  FaStar, FaCalendarAlt, FaMountain, FaUmbrella, FaUtensils, 
  FaChevronDown, FaTimes, FaPhone, FaEnvelope, FaMapMarkerAlt, 
  FaPlus, FaMinus, FaLandmark, FaTree, FaWater, FaBus,
  FaHiking, FaPrayingHands, FaHotel
} from 'react-icons/fa';
import { GiElephant, GiTempleGate, GiShoppingBag, GiVillage } from 'react-icons/gi';
import { MdOutlineHiking, MdFamilyRestroom, MdSpa } from 'react-icons/md';
...
const Nepal = () => {
  ...
  const packages = [
    {
      ...
      price: "$1,299",
      rating: 4.9,
      image: "/images/Nepal1.jpeg",
      type: "popular",
      highlights: [
        "Kathmandu city tour with UNESCO sites",
        "Pashupatinath Temple and Boudhanath Stupa",
        "Pokhara city with Phewa Lake",
    ...
    },
    {
      ...
      highlights: [
        ...
        "Climb Kala Patthar (5,545m) for best views",
    ...
    },
    {
      ...
      price: "$899",
      rating: 4.7,
      image: "/images/Nepal3.jpeg",
      type: "family",
      highlights: [
        "Kid-friendly Kathmandu sightseeing",
        "Pokhara with boat ride on Phewa Lake",
        "Visit International Mountain Museum",
        "Wildlife safari in Chitwan",
        "Cultural shows and interactive experiences",
        "Family-oriented hotels with pools",
    ...
    {
      id: 4,
      title: "Luxury Nepal Experience",
      duration: "8 Days / 7 Nights",
      price: "$2,499",
      rating: 4.6,
      image: "/images/Nepal4.jpeg",
      type: "luxury",
      highlights: [
        "5-star boutique hotels in Kathmandu and Pokhara",
        "Private helicopter tour of Everest region",
        "Spa treatments and yoga sessions",
        "Private guided tours with VIP access",
        "Gourmet Nepali cuisine with wine pairing",
        "Sunrise champagne breakfast with mountain views",
        "Personal concierge service"
      ],
      icon: <MdSpa className="text-2xl text-purple-600" />
    }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.wildlife) specialRequests.push("Wildlife Safari");
    ...
    const templateParams = {
      ...
      accommodationType: formData.accommodationType === 'hotel' ? 'Hotel' : 
                       formData.accommodationType === 'resort' ? 'Resort' : 
                       formData.accommodationType === 'teahouse' ? 'Teahouse' : 'Other',
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-green-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Where the Himalayas meet spiritual enlightenment
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-blue-600 to-green-600 text-white px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all hover:brightness-110"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Experience Nepal's Wonders</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            From the towering peaks of the Himalayas to the spiritual temples of Kathmandu, from wildlife safaris in Chitwan to the serene lakes of Pokhara, Nepal offers an unforgettable blend of adventure, culture, and natural beauty.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Everest, Annapurna, and Himalayan treks"
            },
            {
              icon: <FaPrayingHands className="text-4xl text-green-500" />,
              title: "Spiritual Journeys",
              desc: "Lumbini, Boudhanath, and Pashupatinath"
            },
            {
              icon: <GiElephant className="text-4xl text-amber-600" />,
              title: "Wildlife Safaris",
              desc: "Chitwan and Bardia National Parks"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Nepal Tour Packages</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Nepal.
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      {pkg.type === 'trekking' && 'Trekking Adventure'}
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-blue-600 to-green-600 text-white px-6 py-2 rounded-lg font-medium shadow-md hover:shadow-lg"
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Nepal Through the Lens</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover the diverse beauty of Nepal from Himalayan peaks to ancient temples.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our Nepal Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6 rounded-full"></div>
          </div>
            ...
            {[
              {
                ...
                title: "Local Experts",
                desc: "Knowledgeable about Nepal's rich culture"
              },
              {
                icon: <FaHiking className="text-4xl text-green-600" />,
                title: "Trekking Specialists",
                desc: "Certified guides for Himalayan treks"
              },
              {
                icon: <IoMdRestaurant className="text-4xl text-red-500" />,
                title: "Authentic Cuisine",
                desc: "Taste the best of Nepali food"
              },
              {
                icon: <GiVillage className="text-4xl text-blue-500" />,
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/nepal-bg.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  {/* Package Info Side */}
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-green-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/nepal-bg.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      >
                        ...
                        <button
                          onClick={closeBookingModal}
                          className="bg-gradient-to-r from-blue-600 to-green-600 text-white px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg"
                        >
                          Close
                        </button>
                      </motion.div>
                      ...
                      <>
                        ...
                        <p className="text-gray-600 mb-6">Secure your Nepal tour today</p>
