...
import { 
  ...
  FaPlus, FaMinus, FaCity, FaMountain, FaHorse
} from 'react-icons/fa';
import { GiMoneyStack, GiElephant, GiLion, GiCampingTent } from 'react-icons/gi';
import { MdCasino, MdOutlineHiking, MdFamilyRestroom, MdOutlineWineBar, MdBeachAccess } from 'react-icons/md';
...
const SouthAfrica = () => {
  ...
  const packages = [
    {
      id: 1,
      title: "Classic South Africa Safari",
      ...
      highlights: [
        ...
        "Winelands tour in Stellenbosch",
        "Blyde River Canyon scenic drive",
        "Johannesburg cultural experience",
        "Sunset cruise in Cape Town",
        "Traditional braai (BBQ) dinner"
      ],
      icon: <GiLion className="text-2xl text-yellow-500" />
    },
    {
      id: 2,
      title: "Luxury Safari & Beach Escape",
      ...
      type: "luxury",
      highlights: [
        "Private game reserve safari experience",
        "5-star lodges with private plunge pools",
        "Cape Town stay at luxury waterfront hotel",
        "Private helicopter tour of Cape Peninsula",
        "Exclusive wine tasting in Franschhoek",
        "Beach retreat in Hermanus or Camps Bay",
        "Personal safari guide and tracker",
        "All meals and premium drinks included"
      ],
      icon: <GiCampingTent className="text-2xl text-amber-600" />
    },
    {
      id: 3,
      title: "Family Adventure in South Africa",
      ...
      type: "family",
      highlights: [
        "Kid-friendly safari at Pilanesberg National Park",
        "Cape Town Aquarium and Two Oceans Aquarium",
        "Boulders Beach penguin colony visit",
        "Gold Reef City amusement park",
        "Family-friendly accommodations",
        "Easy game drives suitable for children",
    ...
    {
      id: 4,
      title: "Garden Route & Safari Combo",
      duration: "15 Days / 14 Nights",
      price: "₹1,79,999",
      rating: 4.6,
      image: "/images/SA4.jpeg",
      type: "adventure",
      highlights: [
        "Full Garden Route self-drive or guided tour",
      ...
      icon: <FaMountain className="text-2xl text-green-600" />
    }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.safari) specialRequests.push("Safari Focus");
    if (formData.specialRequests.wine) specialRequests.push("Wine Experiences");
    if (formData.specialRequests.beach) specialRequests.push("Beach Time");
    ...
    const templateParams = {
      ...
      accommodationType: formData.accommodationType === 'lodge' ? 'Safari Lodge' : 
                       formData.accommodationType === 'hotel' ? 'Hotel' : 'Guest House',
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-yellow-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Where the Big Five roam and vibrant cultures thrive
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-amber-600 to-yellow-600 text-white px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all hover:brightness-110"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Rainbow Nation Adventures</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-yellow-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            South Africa offers an incredible diversity of experiences - from thrilling safaris in world-famous game reserves 
            to cosmopolitan Cape Town, stunning beaches, majestic mountains, and award-winning wine regions. Discover why it's 
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <GiLion className="text-4xl text-amber-600" />,
              title: "Wildlife Safaris",
              desc: "See the Big Five in Kruger and other reserves"
            },
            {
              icon: <MdOutlineWineBar className="text-4xl text-purple-600" />,
              title: "Wine & Dine",
              desc: "World-class vineyards and gourmet experiences"
            },
            {
              icon: <MdBeachAccess className="text-4xl text-blue-500" />,
              title: "Coastal Beauty",
              desc: "Pristine beaches and marine wildlife"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-amber-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-yellow-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of South Africa.
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-amber-600 to-yellow-600 text-white px-6 py-2 rounded-lg font-medium shadow-md hover:shadow-lg"
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-amber-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">South Africa's Diversity</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-yellow-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Witness the breathtaking beauty of South Africa through these stunning visuals.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Professional guides with wildlife tracking skills"
              },
              {
                icon: <IoMdTrain className="text-4xl text-blue-500" />,
                title: "Seamless Logistics",
                desc: "Domestic flights and transfers coordinated"
              },
              {
                icon: <GiElephant className="text-4xl text-gray-600" />,
                title: "Conservation Focus",
                desc: "Supporting ethical wildlife experiences"
              },
              {
                icon: <GiCampingTent className="text-4xl text-amber-500" />,
                title: "Authentic Stays",
                desc: "From luxury lodges to boutique hotels"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/sa-safari.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  {/* Package Info Side */}
                  <div className="p-8 bg-gradient-to-b from-amber-600 to-yellow-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/sa-safari.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                    <div className="relative z-10">
                      ...
                      <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm border border-white/20">
                        ...
                        <div className="text-sm opacity-80 mt-1">per person (excluding international flights)</div>
                      </div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      >
                        ...
                        <button
                          onClick={closeBookingModal}
                          className="bg-gradient-to-r from-amber-600 to-yellow-600 text-white px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg"
                        >
                          Close
                        </button>
                      </motion.div>
                      ...
                      <>
                        ...
                        <p className="text-gray-600 mb-6">Secure your South Africa tour today</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={handleChange}
                              className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all bg-white/70"
                              placeholder="e.g. ₹1,30,000 - ₹1,80,000"
                            />
                          </div>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-amber-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="safari"
                                  checked={formData.specialRequests.safari}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-amber-600"
                                />
                                <span>Safari Focus</span>
                              </label>
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-amber-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="wine"
                                  checked={formData.specialRequests.wine}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-amber-600"
                                />
                                <span>Wine Experiences</span>
                              </label>
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-amber-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="beach"
                                  checked={formData.specialRequests.beach}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-amber-600"
                                />
