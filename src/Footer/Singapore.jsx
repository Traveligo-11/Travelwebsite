...
const Singapore = () => {
  ...
  const packages = [
    {
      ...
      type: "popular",
      highlights: [
        "Singapore city tour with Marina Bay Sands",
    ...
    },
    {
      ...
      price: "₹89,999",
      rating: 4.8,
      image: "/images/Singapore2.jpeg",
      type: "luxury",
      highlights: [
        "5-star accommodation in Singapore and KL",
        "Private guided tours",
        "Dining at Michelin-starred restaurants",
        "VIP access to attractions",
        "Luxury shopping experience",
        "Night safari with premium seating",
        "Limousine transfers"
      ],
    ...
    },
    {
      ...
      price: "₹75,999",
      rating: 4.6,
      image: "/images/Singapore4.jpeg",
      type: "beach",
      highlights: [
        "Langkawi island exploration",
        "Pangkor Island resort stay",
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.shopping) specialRequests.push("Shopping Focus");
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Where modern marvels meet tropical paradise
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Dual Country Adventure</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Experience the perfect blend of Singapore's futuristic cityscape and Malaysia's diverse cultural heritage 
            and natural beauty. From towering skyscrapers to ancient rainforests, this journey showcases the best of 
            Southeast Asia's most dynamic destinations.
          </p>
        </div>
          ...
          {[
            {
              ...
              title: "Urban Wonders",
              desc: "Marina Bay Sands, Petronas Towers, and futuristic cityscapes"
            },
            {
              icon: <MdOutlineBeachAccess className="text-4xl text-teal-500" />,
              title: "Tropical Beaches",
              desc: "Pristine islands like Langkawi, Tioman, and Sentosa"
            },
            {
              icon: <MdTempleHindu className="text-4xl text-purple-600" />,
              title: "Cultural Fusion",
              desc: "Chinese, Malay, Indian and colonial influences"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Singapore and Malaysia.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Discover Two Countries</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Witness the diverse beauty of Singapore and Malaysia through these stunning visuals.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Comfortable transport between countries and cities"
              },
              {
                icon: <GiShoppingBag className="text-4xl text-purple-600" />,
                title: "Local Experts",
                desc: "Knowledgeable guides in each destination"
              },
              {
                icon: <GiIsland className="text-4xl text-teal-500" />,
                title: "Diverse Experiences",
                desc: "From urban exploration to island relaxation"
              },
              {
                icon: <FaCity className="text-4xl text-blue-500" />,
                title: "Quality Accommodation",
                desc: "Carefully selected city and resort hotels"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/sg-my-city.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-purple-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/sg-my-city.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      <>
                        ...
                        <p className="text-gray-600 mb-6">Secure your Singapore-Malaysia tour today</p>
