...
import { 
  ...
  FaPlus, FaMinus, FaUmbrellaBeach, FaWater, FaTree
} from 'react-icons/fa';
import { GiMoneyStack, GiIsland } from 'react-icons/gi';
...
const Mauritius = () => {
  ...
  const packages = [
    ...
    },
    {
      ...
      price: "₹65,999",
      rating: 4.7,
      image: "/images/MAU2.jpg",
      type: "adventure",
      highlights: [
        "Visit to Île aux Cerfs",
        "Snorkeling at Blue Bay",
        "Speedboat tour to Northern Isles",
        "Underwater waterfall viewing",
        "Traditional Sega dance show"
      ],
      icon: <IoMdBoat className="text-2xl text-blue-500" />
    },
    {
      id: 3,
    ...
    },
    {
      ...
      price: "₹75,999",
      rating: 4.6,
      image: "/images/MAU4.jpeg",
      type: "family",
      highlights: [
        "Kids club activities",
        "Dolphin watching tour",
        "Casela Nature Park visit",
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.beachFront) specialRequests.push("Beach Front Villa");
    if (formData.specialRequests.diving) specialRequests.push("Scuba Diving");
    if (formData.specialRequests.spa) specialRequests.push("Spa Treatments");
    ...
    const templateParams = {
      ...
      accommodationType: formData.accommodationType === 'hotel' ? 'Hotel' : 
                       formData.accommodationType === 'villa' ? 'Private Villa' : 'Luxury Resort',
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Where turquoise waters meet powder-white sands
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-blue-600 to-white text-blue-900 px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all hover:brightness-110"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-white mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover the jewel of the Indian Ocean with its crystal-clear lagoons, vibrant coral reefs, 
            and lush mountainous interior that create a perfect tropical getaway.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "World-famous white sand beaches"
            },
            {
              icon: <FaWater className="text-4xl text-blue-400" />,
              title: "Marine Life",
              desc: "Vibrant coral reefs and dolphins"
            },
            {
              icon: <FaTree className="text-4xl text-green-600" />,
              title: "Lush Nature",
              desc: "Tropical forests and waterfalls"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Vacation Packages</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-white mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience Mauritius through our carefully curated packages designed for every type of traveler.
            </p>
          </div>
            ...
            {[
              ...
              <motion.button
                ...
                className={`px-6 py-2 rounded-full font-medium transition-all ${
                  activeTab === tab.id
                    ? 'bg-gradient-to-r from-blue-600 to-white text-blue-900 shadow-md'
            ...
            {filteredPackages.map(pkg => (
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  />
                  <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full flex items-center text-blue-600 font-bold">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="text-sm text-gray-600">
                      {pkg.type === 'popular' && 'Popular Choice'}
                      {pkg.type === 'adventure' && 'Adventure Tour'}
                      {pkg.type === 'romantic' && 'Romantic Getaway'}
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-blue-600 to-white text-blue-900 px-6 py-2 rounded-lg font-medium shadow-md hover:shadow-lg"
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Discover Mauritius</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-white mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore the stunning beaches, vibrant culture, and breathtaking landscapes that make Mauritius a dream destination.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our Mauritius Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-white mx-auto mb-6 rounded-full"></div>
          </div>
            ...
            {[
              {
                icon: <GiIsland className="text-4xl text-blue-600" />,
                title: "Local Experts",
                desc: "Born and raised in Mauritius"
              },
              {
                icon: <MdRestaurant className="text-4xl text-gray-700" />,
                title: "Authentic Cuisine",
                desc: "Best local dining experiences"
              },
              {
                icon: <FaWater className="text-4xl text-blue-400" />,
                title: "Marine Specialists",
                desc: "Expert snorkeling/diving guides"
              },
              {
                icon: <FaTree className="text-4xl text-green-600" />,
                title: "Eco-Friendly",
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/mauritius-booking.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  {/* Package Info Side */}
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-white text-blue-900 relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/mauritius-booking.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      >
                        ...
                        <button
                          onClick={closeBookingModal}
                          className="bg-gradient-to-r from-blue-600 to-white text-blue-900 px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg"
                        >
                          Close
                        </button>
                      </motion.div>
                      ...
                      <>
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your Mauritius Getaway</h3>
                        <p className="text-gray-600 mb-6">Secure your island vacation today</p>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="beachFront"
                                  checked={formData.specialRequests.beachFront}
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="spa"
                                  checked={formData.specialRequests.spa}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-blue-600"
                                />
                          ...
                          <div className="pt-2">
                            <motion.button
                              ...
                              className={`w-full py-4 px-6 rounded-xl font-bold text-white shadow-lg transition-all ${
                                isSubmitting
                                  ? 'bg-gray-400'
                                  : 'bg-gradient-to-r from-blue-600 to-white text-blue-900 hover:from-blue-700'
                              }`}
                            >
                              {isSubmitting ? (
