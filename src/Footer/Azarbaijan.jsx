...
import { GiMoneyStack, GiNightSky, GiOilDrum } from 'react-icons/gi';
...
const Azerbaijan = () => {
  ...
  const packages = [
    {
      id: 1,
      title: "Azerbaijan Cultural Journey",
    ...
    {
      id: 2,
      title: "Azerbaijan Luxury Experience",
      duration: "6 Days / 5 Nights",
      price: "₹89,999",
      rating: 4.9,
      image: "/images/Azerbaijan2.jpeg",
      type: "luxury",
      highlights: [
        "5-star accommodations in Baku",
        "Private guided tours",
        "Gourmet Azerbaijani cuisine",
        "VIP access to cultural sites",
        "Caspian Sea yacht experience"
      ],
      icon: <GiMoneyStack className="text-2xl text-amber-600" />
    },
    {
      id: 3,
      title: "Azerbaijan Nature & Adventure",
      duration: "8 Days / 7 Nights",
      price: "₹72,999",
      rating: 4.6,
      image: "/images/Azerbaijan3.jpeg",
      type: "adventure",
      highlights: [
        "Hiking in the Caucasus Mountains",
        "Gabala region exploration",
    ...
    {
      id: 4,
      title: "Azerbaijan Heritage Tour",
      duration: "5 Days / 4 Nights",
      price: "₹49,999",
      rating: 4.5,
      image: "/images/Azerbaijan4.jpeg",
      type: "heritage",
      highlights: [
        "UNESCO-listed sites tour",
        "Shirvanshahs' Palace",
        "Maiden Tower visit",
        "Mud volcanoes experience",
  ...
  const galleryImages = [
    ...
    "/images/Azerbaijan2.jpeg",
    "/images/Azerbaijan3.jpeg",
    "/images/Azerbaijan4.jpeg",
    "/images/Azerbaijan5.jpeg",
    "/images/Azerbaijan6.jpeg",
    "/images/Azerbaijan7.jpeg",
    "/images/Azerbaijan8.jpeg",
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-amber-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Where ancient history meets modern architecture and natural wonders
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Land of Fire</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-amber-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover Azerbaijan's unique blend of East and West, where ancient Zoroastrian fire temples stand 
            alongside futuristic architecture, and the Caucasus Mountains meet the Caspian Sea.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <GiOilDrum className="text-4xl text-blue-600" />,
              title: "Land of Fire",
              desc: "Ancient fire temples and modern flame-inspired architecture"
            },
            {
              icon: <FaBuilding className="text-4xl text-amber-500" />,
              title: "Architectural Marvels",
              desc: "From medieval Old City to futuristic Flame Towers"
            },
            {
              icon: <FaUtensils className="text-4xl text-red-600" />,
              title: "Rich Cuisine",
              desc: "Flavorful kebabs, plov, and aromatic saffron dishes"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-amber-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our carefully curated packages that showcase the best of Azerbaijan's culture, nature, and history.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Discover Azerbaijan</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-amber-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore the stunning landscapes, architectural wonders, and cultural treasures of Azerbaijan.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                desc: "Traditional meals with local families"
              },
              {
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/azerbaijan-booking.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-amber-700 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/azerbaijan-booking.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      <>
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your Azerbaijan Adventure</h3>
