...
import { 
  FaStar, FaCalendarAlt, FaMosque, FaUmbrella, FaShoppingBasket, 
  FaChevronDown, FaTimes, FaPhone, FaEnvelope, FaMapMarkerAlt, 
  FaPlus, FaMinus, FaLandmark, FaUtensils
} from 'react-icons/fa';
import { GiMoneyStack, GiDesert } from 'react-icons/gi';
...
const Uzbekistan = () => {
  ...
  const packages = [
    {
      ...
      price: "₹58,999",
      rating: 4.8,
      image: "/images/Uzbekistan1.jpeg",
      type: "popular",
      highlights: [
        "Explore Registan Square in Samarkand",
        "Visit Bukhara's historic center",
        "Khiva's walled city Itchan Kala",
        "Tashkent modern & old city tour",
        "Traditional Uzbek craft workshops"
      ],
      icon: <FaStar className="text-2xl text-yellow-500" />
    },
    {
      id: 2,
      title: "Uzbekistan Cultural Immersion",
      duration: "9 Days / 8 Nights",
      price: "₹72,999",
      rating: 4.9,
      image: "/images/Uzbekistan2.jpeg",
      type: "cultural",
      highlights: [
        "Private guided tours of UNESCO sites",
        "Traditional paper-making in Samarkand",
        "Silk weaving demonstrations",
        "Uzbek cooking masterclass",
    ...
    {
      id: 3,
      title: "Golden Road to Samarkand",
      duration: "5 Days / 4 Nights",
      price: "₹49,999",
      rating: 4.7,
      image: "/images/Uzbekistan3.jpg",
      type: "heritage",
      highlights: [
        "Gur-e-Amir mausoleum",
        "Bibi-Khanym Mosque",
        "Ulugh Beg Observatory",
        "Siyob Bazaar experience",
        "Shah-i-Zinda necropolis"
      ],
      icon: <FaMosque className="text-2xl text-teal-600" />
    },
    {
      id: 4,
      ...
      price: "₹65,999",
      rating: 4.6,
      image: "/images/Uzbekistan4.avif",
      type: "adventure",
      highlights: [
        "Kyzylkum Desert safari",
        "Aydar Lake boat trip",
        "Nurata mountain villages",
        "Yurt camp experience",
        "Camel trekking"
      ],
      icon: <GiDesert className="text-2xl text-amber-600" />
    }
  ];

  const galleryImages = [
    "/images/Uzbekistan1.jpeg",
   "/images/Uzbekistan2.jpeg",
    "/images/Uzbekistan3.jpg",
    "/images/Uzbekistan4.avif",
    "/images/Uzbekistan5.jpeg",
    "/images/Uzbekistan6.jpeg",
    "/images/Uzbekistan7.jpeg",
    "/images/Uzbekistan8.jpeg",
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.specialRequests.shopping) specialRequests.push("Shopping for Crafts");
    if (formData.specialRequests.desert) specialRequests.push("Desert Activities");
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-teal-50">
      ...
      <div className="relative h-96 md:h-screen max-h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            >
              Heart of the Silk Road with dazzling Islamic architecture
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Pearl of the Silk Road</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover Uzbekistan's magnificent blue-domed mosques, bustling bazaars, and ancient cities that were 
            once the crossroads of civilizations along the legendary Silk Road.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <SiYourtraveldottv className="text-4xl text-blue-600" />,
              title: "Silk Road Legacy",
              desc: "Historic cities of Samarkand, Bukhara & Khiva"
            },
            {
              icon: <FaMosque className="text-4xl text-teal-600" />,
              title: "Architectural Marvels",
              desc: "Stunning Islamic architecture & mosaics"
            },
            {
              icon: <FaShoppingBasket className="text-4xl text-amber-600" />,
              title: "Vibrant Bazaars",
              desc: "Silks, spices & traditional crafts"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Journey through Uzbekistan's most spectacular destinations with our carefully curated tours.
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      {pkg.type === 'cultural' && 'Cultural Experience'}
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Uzbekistan's Treasures</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Marvel at the architectural wonders and vibrant culture of Uzbekistan through these images.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Our Uzbekistan Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-6 rounded-full"></div>
          </div>
            ...
            {[
              {
                ...
                title: "Silk Road Experts",
                desc: "Deep knowledge of Uzbekistan's history"
              },
              {
                icon: <FaUtensils className="text-4xl text-amber-600" />,
                title: "Culinary Experiences",
                desc: "Authentic plov cooking demonstrations"
              },
              {
                icon: <MdOutlineCastle className="text-4xl text-teal-600" />,
                title: "UNESCO Access",
                desc: "Special access to heritage sites"
              },
              {
                icon: <GiDesert className="text-4xl text-orange-600" />,
                title: "Desert Adventures",
                desc: "Authentic yurt stays & camel rides"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              <div className="absolute inset-0 bg-[url('/images/uzbekistan-booking.jpg')] bg-cover bg-center opacity-20 rounded-2xl"></div>
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                  {/* Package Info Side */}
                  <div className="p-8 bg-gradient-to-b from-blue-600 to-teal-600 text-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('/images/uzbekistan-booking.jpg')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                  ...
                  <div className="p-8 bg-white/90 backdrop-blur-sm">
                    {submitSuccess ? (
                      ...
                      <>
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Reserve Your Uzbekistan Adventure</h3>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                              ...
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                                <input
                                  ...
                                  className="rounded text-blue-600"
                                />
                                <span>Shopping for Crafts</span>
                              </label>
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                                <input
                                  type="checkbox"
                                  name="desert"
                                  checked={formData.specialRequests.desert}
                                  onChange={handleSpecialRequestChange}
                                  className="rounded text-blue-600"
                                />
                                <span>Desert Activities</span>
                              </label>
                              <label className="flex items-center space-x-2 bg-white p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                                <input
                                  type="checkbox"
