...
function App() {
  useEffect(() => {
    ...
    if (!document.getElementById('shapo-widget-b33b95e2144c34fb2f12')) {
      const widgetDiv = document.createElement('div');
      widgetDiv.id = 'shapo-widget-b33b95e2144c34fb2f12';
      document.body.appendChild(widgetDiv);
    }

    // Load Shapo script if not already loaded
  ...
  return (
    <Router>
      <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        {/* Shapo Widget Container - Fixed position */}
        <div id="shapo-widget-b33b95e2144c34fb2f12" style={{
